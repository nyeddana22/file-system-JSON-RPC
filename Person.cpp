...
{
  person_count++;
  std::cout << "Person Core Constructor" << std::endl;
}
...
Person::Person(std::string core_arg_host_url, std::string core_arg_owner_vsID,
       std::string core_arg_class_id, std::string core_arg_object_id, std::string arg_name, std::string arg_id)
  : Core { core_arg_host_url, core_arg_owner_vsID, core_arg_class_id, core_arg_object_id }
{
  this->name = arg_name;
  this->vsID = arg_id;
...
Person::Person(std::string arg_name, std::string arg_id)
{
  this->name = arg_name;
  this->vsID = arg_id;
}
